...
export default function GuidelineArticle({ slug, overrideText }){
  ...
  const exportPdf = async () => {
    ...
    for (let i = 1; i <= pages; i++) {
      pdf.setPage(i);
      pdf.setFontSize(9);
      pdf.text(t('disclaimers.pdf','Disclaimer: Generated by Vancomyzer®. For educational use only. Verify with institutional policies before applying clinically.'), 72, pageHeight - 24);
