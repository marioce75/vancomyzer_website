...
import BayesianSimulator from "@/components/BayesianSimulator";
...
function HomePage() {
  ...
  const [mode, setMode] = useState<"auc" | "bayesian">("auc");
    ...
    <DisclaimerGate>
      <div className="min-h-screen pb-24">
        ...
        <main className="max-w-6xl mx-auto p-4">
          ...
          <Tabs value={mode} onValueChange={(value) => setMode(value as "auc" | "bayesian")}>
            <TabsList className="mb-6">
              <TabsTrigger value="auc">AUC Mode</TabsTrigger>
              <TabsTrigger value="bayesian">Bayesian Mode</TabsTrigger>
            </TabsList>
