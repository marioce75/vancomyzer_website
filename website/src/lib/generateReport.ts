  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .watermark-overlay {
      ...
      pointer-events: none;
      z-index: 9999;
      background-image: url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='520' height='180' viewBox='0 0 520 180'><text x='260' y='90' fill='%230d9488' fill-opacity='0.18' font-size='22' font-family='Arial,sans-serif' font-weight='600' text-anchor='middle' transform='rotate(-30 260 90)'>Generated by Vancomyzer™ — vancomyzer.com — Individual Use Only</text></svg>");
...
<body>
  ...
  ${tier === "free" ? `
  <div class="watermark-overlay">Generated by Vancomyzer\u2122 \u2014 vancomyzer.com \u2014 Individual Use Only</div>
  <div class="free-banner">
    This calculation was generated using the free individual tier of Vancomyzer\u2122.
    For institutional deployment without watermarks, contact
    <a href="mailto:contact@vancomyzer.com" style="color:#0d9488">contact@vancomyzer.com</a>.
  </div>
  ` : ""}
</body>
</html>`;
