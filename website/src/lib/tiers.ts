...
export const TIERS: Record<TierId, TierConfig> = {
  ...
  individual_pro: {
    id: "individual_pro",
    name: "Individual Pro",
    priceLabel: "$49.99/year · billed annually",
  ...
  department: {
    ...
    audience: "Teams needing administration, audit logs and institutional agreements",
    features: [
  ...
  hospital: {
    ...
    features: [
      ...
      "Security documentation available for institutional review",
