    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="mt-8 space-y-8 text-slate-700">
        ...
        <section>
          ...
          <p className="mt-3">Cancel online through Settings → Billing → Manage billing / cancel. Administrators of existing institutional subscriptions use Team → Manage billing. Cancel before the trial ends to avoid a charge, or before the next renewal to stop that charge. Cancellation stops future renewal; access continues through the remaining paid period unless otherwise stated in your agreement.</p>
