...
export default function CalculatorLayout({ left, right }: CalculatorLayoutProps) {
  return (
    <div className="flex h-full w-full flex-col overflow-hidden xl:flex-row">
      <div className="custom-scrollbar z-10 flex h-full w-full shrink-0 flex-col overflow-y-auto px-5 py-5 md:w-[430px] lg:w-[470px] lg:px-6 lg:py-6" style={{ borderRight: "1px solid #003b00", background: "#050505" }}>
        {left}
      </div>
